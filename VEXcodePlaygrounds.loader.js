      ...
      try {
        for (var o in p)
          if (p[o].hasUnityMarker(e)) {
            ...
            return (
              (i.worker.callbacks[s] = r),
              void i.worker.postMessage({ id: s, compressed: e }, [e.buffer])
            );
          }
        r(e);
      } catch (e) {
  ...
  (document.addEventListener("webkitfullscreenchange", function (t) {
    ...
    r === e
      ? e.style.width &&
        ...
        (e.style.width = "100%"),
        (e.style.height = "100%"))
      : g && ((e.style.width = g), (e.style.height = m), (g = ""), (m = ""));
  }),
    c.deinitializers.push(function () {
        ...
        function n() {
          return "undefined" == typeof i
            ...
            : i.read().then(function (e) {
                return e.done
                  ? o()
                  : (f + e.value.length <= l.length
                      ? (l.set(e.value, f), (u = f + e.value.length))
                      : d.push(e.value),
                    (f += e.value.length),
                    r({
                      type: "progress",
      ...
      function e(e, t) {
        ...
        return (
          ...
          fetch(e, t).then(function (e) {
            return c.readBodyWithProgress(e, r);
          })
        );
      }
      return e;
        ...
        var t = {
          "inflate.js": function (e, t, r) {
            ...
            function n(e) {
              ...
              if (r !== d.Z_OK) throw new Error(f[r]);
              ((this.header = new c()),
                ...
                (c.next_out &&
                  ((0 !== c.avail_out &&
                    ...
                    ("string" === this.options.to
                      ? ((o = l.utf8border(c.output, c.next_out)),
                        (i = c.next_out - o),
          ...
          "utils/strings.js": function (e, t, r) {
            ...
            ((s[254] = s[254] = 1),
              (r.string2buf = function (e) {
                ...
                for (t = new o.Buf8(l), a = 0, i = 0; a < l; i++)
                  ((r = e.charCodeAt(i)),
                    55296 === (64512 & r) &&
                      i + 1 < s &&
                      ((n = e.charCodeAt(i + 1)),
          ...
          "zlib/inflate.js": function (e, t, r) {
            ...
            function f(e) {
              if (ve) {
                var t;
                for (
                  m = new p.Buf32(512), w = new p.Buf32(32), t = 0;
                  t < 144;
                )
                  e.lens[t++] = 8;
                ...
                for (
                  _(S, e.lens, 0, 288, m, 0, e.work, { bits: 9 }), t = 0;
                  t < 32;
                )
                  e.lens[t++] = 5;
                (_(E, e.lens, 0, 32, w, 0, e.work, { bits: 5 }), (ve = !1));
              }
              ((e.lencode = m),
                (e.lenbits = 9),
                (e.distcode = w),
            ...
            function u(e, t, r, n) {
              ...
              return (
                ...
                n >= i.wsize
                  ? (p.arraySet(i.window, t, r - i.wsize, i.wsize, 0),
                    (i.wnext = 0),
                    (i.whave = i.wsize))
                  : ((o = i.wsize - i.wnext),
                    o > n && (o = n),
              ...
              e: for (;;)
                switch (r.mode) {
                  ...
                  case ie:
                    for (
                      ;
                      (Ue = r.distcode[c & ((1 << r.distbits) - 1)]),
                        (me = Ue >>> 24),
                        (we = (Ue >>> 16) & 255),
                        (pe = 65535 & Ue),
                        !(me <= h);
                    ...
                    if (((c >>>= me), (h -= me), (r.back += me), 64 & we)) {
                      ((e.msg = "invalid distance code"), (r.mode = ce));
                      break;
                    }
                    ((r.offset = pe), (r.extra = 15 & we), (r.mode = ae));
                  case ae:
                    if (r.extra) {
                      for (Ee = r.extra; h < Ee; ) {
                        if (0 === l) break e;
                  ...
                  case se:
                    ...
                    if (((m = g - d), r.offset > m)) {
                      ...
                      (m > r.wnext
                        ...
                        (ge = r.window));
                    } else ((ge = i), (w = s - r.offset), (m = r.length));
              ...
              return (
                ...
                (r.wsize ||
                  (g !== e.avail_out &&
                    r.mode < ce &&
                    (r.mode < de || t !== U))) &&
                u(e, e.output, e.next_out, g - e.avail_out)
                  ? ((r.mode = he), I)
                  : ((b -= e.avail_in),
                    (g -= e.avail_out),
                    (e.total_in += b),
                    ...
                    r.wrap &&
                      ...
                      (e.adler = r.check =
                        r.flags
                          ? k(r.check, i, g, e.next_out - g)
                          : v(r.check, i, g, e.next_out - g)),
                    (e.data_type =
                      r.bits +
                      (r.last ? 64 : 0) +
                      (r.mode === Y ? 128 : 0) +
                      (r.mode === re || r.mode === X ? 256 : 0)),
                    ((0 === b && 0 === g) || t === U) && xe === T && (xe = z),
                    xe)
              );
            }
            function h(e) {
            ...
            function b(e, t) {
              ...
              return e && e.state
                ? ((r = e.state),
                  0 === (2 & r.wrap) ? A : ((r.head = t), (t.done = !1), T))
                : A;
            }
            function g(e, t) {
              var r,
          ...
          "zlib/inftrees.js": function (e, t, r) {
            ...
            t.exports = function (e, t, r, b, g, m, w, p) {
              var v,
                ...
                W = 0;
              for (T = 0; T <= o; T++) D[T] = 0;
              for (L = 0; L < b; L++) D[t[r + L]]++;
              for (O = B, A = o; A >= 1 && 0 === D[A]; A--);
              if ((O > A && (O = A), 0 === A))
                return (
                  (g[m++] = 20971520),
                  (g[m++] = 20971520),
              ...
              for (R = 1; R < A && 0 === D[R]; R++);
              for (O < R && (O = R), P = 1, T = 1; T <= o; T++)
                if (((P <<= 1), (P -= D[T]), P < 0)) return -1;
              if (P > 0 && (e === s || 1 !== A)) return -1;
              for (j[1] = 0, T = 1; T < o; T++) j[T + 1] = j[T] + D[T];
              for (L = 0; L < b; L++) 0 !== t[r + L] && (w[j[t[r + L]]++] = L);
              if (
                (e === s
                  ? ((Z = M = w), (S = 19))
                  : e === l
                    ? ((Z = f), (H -= 257), (M = u), (W -= 257), (S = 256))
                    : ((Z = c), (M = h), (S = -1)),
                (N = 0),
                (L = 0),
                (T = R),
              ...
              for (;;) {
                ...
                if (T > O && (N & _) !== y) {
                  for (
                    0 === z && (z = O), x += R, I = T - z, P = 1 << I;
                    I + z < A && ((P -= D[I + z]), !(P <= 0));
                  )
                    (I++, (P <<= 1));
                  if (((F += 1 << I), (e === l && F > i) || (e === d && F > a)))
                    return 1;
                  ((y = N & _), (g[y] = (O << 24) | (I << 16) | (x - m) | 0));
                }
              }
              return (
                0 !== N && (g[x + N] = ((T - z) << 24) | (64 << 16) | 0),
                (p.bits = O),
                0
              );
            };
        ...
        c.SystemInfo.hasWasm
          ? ((c.startupErrorHandler = t),
            ...
            c.postRun.push(function () {
              (r(1), delete c.startupErrorHandler, e(w));
            }),
            u())
